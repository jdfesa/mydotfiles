...
Parcialmente adaptado. El selector local ya solo actualiza
`shared/colorscheme/active/active-colorscheme.sh` dentro de `~/mydotfiles`; no
toca wallpaper, Yabai, Sketchybar ni servicios del sistema.
