...
ln -s ~/mydotfiles/shared/zsh/zshrc ~/.zshrc
```
...
La configuracion principal ya lo incluye en `shared/zsh/zshrc`. En una Mac nueva
basta con enlazar `~/.zshrc` hacia `~/mydotfiles/shared/zsh/zshrc`.
