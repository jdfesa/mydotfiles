...
- `shared/nvim/lazy-lock.json` para plugins instalados por `lazy.nvim`.
- `shared/nvim/docs/DEPENDENCIES.md` para paquetes descargados por Mason y
  parsers de Treesitter.
- `shared/nvim/docs/SETUP_LOG.md` para acciones manuales hechas durante una
  migracion.
...
|---|---|---|---|
| Config Neovim | `shared/nvim/` | Si | symlink a `~/.config/nvim` |
| Plugins Lazy | `shared/nvim/lazy-lock.json` | Si | `nvim --headless "+Lazy! sync" +qa` |
