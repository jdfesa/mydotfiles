...
```bash
ln -s ~/mydotfiles/shared/sesh ~/.config/sesh
```

En esta maquina no habia una config previa en `~/.config/sesh`, asi que el enlace
se puede crear directamente. La fuente de verdad queda en
`~/mydotfiles/shared/sesh`.
