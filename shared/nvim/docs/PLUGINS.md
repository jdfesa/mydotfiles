...
```text
shared/nvim/lua/plugins/extras.lua
```
...
| Plugin | Rol | Comentario |
|---|---|---|
| `tokyonight.nvim` | Tema actual | Seleccionado en `shared/nvim/lua/plugins/core.lua`. |
...
- Plugins propios: crear/editar archivo en `shared/nvim/lua/plugins/`.
- Lenguajes soportados por LazyVim: preferir extras en
  `shared/nvim/lua/plugins/extras.lua`.
