...
-- Register the custom events that aerospace.toml triggers
...
function Window_Manager:init()
  ...
  -- Mode Indicator (hidden by default, shows up when in service mode)
