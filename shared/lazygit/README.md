...
```bash
~/Library/Application Support/lazygit/config.yml -> ~/mydotfiles/shared/lazygit/config.yml
```
...
Editar `shared/lazygit/config.yml` y cambiar:
...
```bash
git restore shared/lazygit/config.yml shared/lazygit/README.md shared/lazygit/SOURCES.md
```
