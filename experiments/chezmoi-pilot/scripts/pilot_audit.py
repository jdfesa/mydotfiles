...
AUTOMATED_CHECKS = {
    ...
    "UT-OPENSPEC-OVERRIDE": "experiments/chezmoi-pilot/tests/test_pilot.py::test_openspec_explicit_override_precedes_path",
    "UT-OPENSPEC-PATH": "experiments/chezmoi-pilot/tests/test_pilot.py::test_openspec_path_discovery_precedes_user_local",
    "UT-OPENSPEC-POSIX-FALLBACK": "experiments/chezmoi-pilot/tests/test_pilot.py::test_openspec_posix_user_local_fallback_with_stripped_path",
    "UT-OPENSPEC-MISSING": "experiments/chezmoi-pilot/tests/test_pilot.py::test_openspec_missing_executable_has_safe_diagnostic",
